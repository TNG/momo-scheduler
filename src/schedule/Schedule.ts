...
export class Schedule extends LogEmitter {
   ...
   * @param parameters the parameters that will be passed to the job for this single run; passing nothing will run the job with no parameters, NOT the parameters used for the scheduled runs
